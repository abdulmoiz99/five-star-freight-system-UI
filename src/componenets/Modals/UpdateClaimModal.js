...
import { claimStatus } from "../../shared/DropDownCache";

export default function UpdateClaimModal(props) {
    return (
        <>
            {props.showModal ? (
                <>
                            ...
                            >
                                ...
                                <div className="w-full px-4 pt-4">
                                    <div className="relative w-full mb-3">
                                        ...
                                        <Select
                                            options={claimStatus}
                                            value={{ value: props.status, label: props.status }}
                                            onChange={(selectedOption) => {
                                                props.setStatus(selectedOption.value)
                                            }}
                                        />
                                    </div>
                                </div>
